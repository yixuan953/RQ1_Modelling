...
// Fertilizer inputs
extern void IfFertilization();      // If fertilization is applied before sowing
extern void IfMultiFertilization(); // If multiple fertilization is applied based on crop DVS
