...
#-----------------------------Output files-----------------------------
#SBATCH --output=/lustre/nobackup/WUR/ESG/zhou111/1_RQ1_Code/2_Modelling/S0_Select_SowingDate_TSUM/HPC_Report/output_%j.txt
#SBATCH --error=/lustre/nobackup/WUR/ESG/zhou111/1_RQ1_Code/2_Modelling/S0_Select_SowingDate_TSUM/HPC_Report/error_output_%j.txt
#-----------------------------Other information------------------------
...
# ./wofost-S0-rice list_Indus_mainrice.txt meteolist_WFDE5_Indus_mainrice.txt 
# ./wofost-S0-rice list_LaPlata_mainrice.txt meteolist_WFDE5_LaPlata_mainrice.txt 
# ./wofost-S0-rice list_Yangtze_mainrice.txt meteolist_WFDE5_Yangtze_mainrice.txt 
# ./wofost-S0-rice list_Yangtze_secondrice.txt meteolist_WFDE5_Yangtze_secondrice.txt 
