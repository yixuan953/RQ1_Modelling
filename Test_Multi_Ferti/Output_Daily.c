...
{
    fprintf(fp_do,"Lat,Lon,Year,Day,Dev_Stage,Demand_grain,Transpiration,EvaWater,EvaSoil,SoilMoisture,SurfaceRunoff,SubsurfaceRunoff,Percolation,TSMD,Fertilization,N_avail,N_demand,P_demand,N_uptake,P_uptake,Lpool,Spool,Prepool,P_avail,P_Surf,P_Sub,P_Leaching,cPi,RootDepth,N_decomp,P_decomp\n");
}
...
{      
         fprintf(fp_do,"%7.2f,%7.2f,%4d,%3d," // Lat, Lon, MeteoYear, MeteoDay
                ...
                // Max_P_demand_lv,Max_P_demand_st,Max_P_demand_ro,st_lv,st_st,st_ro
